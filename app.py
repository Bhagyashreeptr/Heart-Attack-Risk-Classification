...
# Age RestingBP Cholestrol FastingBs MaxHR Oldpeak
...
Cholestrol = st.number_input('Cholestrol',min_value=0,max_value=650,value=100)
...
ExcerciseAngina=st.selectbox('ExcerciseAngina',('Y','N'))
ST_Slope=st.selectbox('ST_Slope',('Up','Flat','Down'))


# Sex ChestPainType RestingECG ExcerciseAngina ST_Slope
...
excerciseAngina=1 if ExcerciseAngina=='Y'else 0
...
input_features=pd.DataFrame({
    ...
    'Oldpeak':[Oldpeak],
    'sex':[sex],
    'exerciseAngina':[excerciseAngina],
...
input_features[['Age','RestingBP','Cholesterol','FastingBS','MaxHR','Oldpeak']]=scaler.fit_transform(input_features[['Age','RestingBP','Cholesterol','FastingBS','MaxHR','Oldpeak']])
